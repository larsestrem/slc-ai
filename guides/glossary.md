...
- **Memory care** - secured, dementia-specific care with trained staff. [Full guide](/guides/memory-care/).
- **Sundowning** - increased confusion or agitation in late afternoon/evening, common with dementia; a reason memory care staffing patterns matter.
- **Elopement** - the industry term for a resident with dementia leaving a building unsupervised; secured units exist to prevent it.
- **Two-person transfer** - needing two staff members to move safely (bed to wheelchair, etc.). Many assisted living communities can't accommodate it - a common discharge trigger to ask about.
- **Respite care** - a short-term stay for caregiver relief, recovery, or a trial run. [Full guide](/guides/respite-care/).
- **Hospice / palliative care** - comfort-focused care; palliative alongside treatment, hospice near end of life (a Medicare-covered service, not a place). [Full guide](/guides/hospice-and-palliative-care/).

## Housing types

- **Independent living (IL)** - housing plus meals, activities, and housekeeping; no hands-on care. [Full guide](/guides/independent-living/).
- **Assisted living (AL / ALF)** - daily personal-care help in a residential setting; not a medical facility. [Full guide](/guides/assisted-living/).
- **Skilled nursing facility (SNF / "nursing home")** - 24/7 licensed nursing care; also where Medicare-covered short-term rehab happens. [Full guide](/guides/skilled-nursing/).
- **CCRC / Life Plan Community** - one campus with every care level and a contract (types A/B/C) that governs lifetime costs; usually an entrance fee. [Full guide](/guides/ccrc-life-plan-communities/).
- **Adult family home / adult foster home / RCFE / board and care** - state names for small residential care homes (roughly 5-10 residents) run in houses; often owner-operated with high attention. [Full guide](/guides/adult-family-homes/).
- **Home care vs. home health** - home care is non-medical help (aides, companionship), paid privately or by Medicaid; home health is physician-ordered skilled care (nursing, therapy) that Medicare covers short-term. [Full guide](/guides/in-home-care-explained/).
- **55+ / active adult community** - age-restricted housing with no services; real estate, not care.
...
- **MERP (Medicaid Estate Recovery Program)** - the state's claim against the estate after a Medicaid recipient 55+ dies. [What families need to know](/guides/medicaid-estate-recovery/).
- **Private pay** - paying from savings/income; many communities require 1-2 years of it before accepting Medicaid.
...
- **Placement specialist / senior living advisor** - helps families find communities, paid a referral fee by the community chosen (like a realtor's commission). [How that works](/guides/finding-help-choosing-a-facility/).
- **Geriatric care manager (aging life care professional)** - a nurse or social worker you pay hourly to assess, plan, and advocate; no placement commissions.
