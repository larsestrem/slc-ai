---
layout: guide
title: "CCRCs and Life Plan Communities: Contracts, Fees, Risks"
description: "How CCRCs (Life Plan communities) work: Type A, B, and C contracts in plain language, entrance fees and refunds, and how to judge financial strength."
permalink: /guides/ccrc-life-plan-communities/
...
faqs: [{"q": "What happens if I outlive my money?", "a": "Ask this before signing — it's the single most important question. Many nonprofit CCRCs have benevolence or fellowship funds and a written policy of not evicting residents who deplete assets through no fault of their own. But policies differ, some are discretionary rather than guaranteed, and for-profit communities may simply require you to leave. Get the policy in writing, and ask whether any of the campus's nursing beds accept Medicaid — see Medicaid vs. Medicare."}, {"q": "Is the entrance fee tax-deductible?", "a": "A portion of Type A and B entrance fees and monthly fees may be deductible as prepaid medical expense. The community issues an annual percentage. Confirm with a tax professional — rules are specific."}, {"q": "Can I be forced to move to a higher level of care?", "a": "Contracts generally give the community's medical team significant say in transfers, usually with a consultation process. Read the transfer clause and ask how disagreements are resolved."}, {"q": "\"Life Plan community\" — is that different from a CCRC?", "a": "No. It's the same model, renamed by the industry in 2015 because \"continuing care\" tested poorly. Same contracts, same questions."}, {"q": "Do CCRC guarantees replace long-term care insurance?", "a": "A true Type A contract covers much of the same risk, and insurers know it — some residents drop or reduce coverage after moving in. A Type C contract covers none of it. Talk to a fee-only financial planner before canceling anything."}]
---
...
A CCRC is a campus that offers [independent living](/guides/independent-living/), [assisted living](/guides/assisted-living/), [memory care](/guides/memory-care/), and [skilled nursing](/guides/skilled-nursing/) in one place. Residents typically move in while still independent — most CCRCs require it — and transfer between levels as needs change, without leaving the community or their spouse behind. See our [levels of care overview](/guides/levels-of-care-explained/) for what each level involves.
...
- **Declining (amortizing) plans:** the refund shrinks over time — often 1–2% per month — reaching zero after several years. Lowest entrance fee.
- **Partial refund plans:** 50% or 90% of the entrance fee is returned to you or your estate, whenever you leave or die. You pay a meaningfully higher entrance fee for that guarantee.
...
- **Read the disclosure statement.** Most states require one; get it even where not required. Look at audited financials for the last three years.
- **Occupancy.** Independent living occupancy around 90% or better is healthy. Occupancy sliding below the mid-80s is a warning sign — entrance fees from new residents are the engine of the whole model.
- **Liquidity and debt.** Ask about days cash on hand (several hundred is comfortable) and debt service coverage. A nonprofit's bond ratings and disclosures are often posted publicly on the EMMA municipal bond site.
- **Actuarial soundness.** A well-run Type A community has a recent actuarial study confirming it can fund the care it has promised current residents. Ask when the last one was done and whether it found a surplus.
- **Who owns it and how long they've operated.** A single-site nonprofit with 40 years of history, a large multi-site system, and a leveraged for-profit developer are three very different risk profiles.
...
It's a poorer fit for someone who already needs daily care (most CCRCs won't admit directly to higher levels under a life contract), whose money would be exhausted by the entrance fee, or who may want to move near family later — exiting a CCRC contract is costly. Compare alternatives in our [types of senior living facilities guide](/guides/types-of-senior-living-facilities/), including a shorter [respite stay](/guides/respite-care/) to sample campus life before committing.

## Common questions

**What happens if I outlive my money?**
Ask this before signing — it's the single most important question. Many nonprofit CCRCs have benevolence or fellowship funds and a written policy of not evicting residents who deplete assets through no fault of their own. But policies differ, some are discretionary rather than guaranteed, and for-profit communities may simply require you to leave. Get the policy in writing, and ask whether any of the campus's nursing beds accept Medicaid — see [Medicaid vs. Medicare](/guides/medicaid-vs-medicare/).

**Is the entrance fee tax-deductible?**
A portion of Type A and B entrance fees and monthly fees may be deductible as prepaid medical expense. The community issues an annual percentage. Confirm with a tax professional — rules are specific.

**Can I be forced to move to a higher level of care?**
Contracts generally give the community's medical team significant say in transfers, usually with a consultation process. Read the transfer clause and ask how disagreements are resolved.

**"Life Plan community" — is that different from a CCRC?**
No. It's the same model, renamed by the industry in 2015 because "continuing care" tested poorly. Same contracts, same questions.

**Do CCRC guarantees replace long-term care insurance?**
A true Type A contract covers much of the same risk, and insurers know it — some residents drop or reduce coverage after moving in. A Type C contract covers none of it. Talk to a fee-only financial planner before canceling anything.

## Where to get help

- **Your state's CCRC regulator** (often the insurance department or department of aging) can tell you what disclosures are required and whether complaints are on file.
- **An elder law attorney** should review any CCRC contract before you sign — this is worth repeating.
- **Eldercare Locator** (1-800-677-1116) connects you to unbiased local counseling through your Area Agency on Aging.
