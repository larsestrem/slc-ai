---
layout: guide
title: "In-Home Care Explained: Types, Schedules, and Services"
description: "Understand the types of in-home care for seniors - companion care, home care aides, home health, and 24-hour care - and which fits your parent."
permalink: /guides/in-home-care-explained/
...
faqs: [{"q": "What's the difference between \"home care\" and \"home health\"?", "a": "Home care is non-medical help with daily living - bathing, meals, companionship - paid mostly out of pocket or through Medicaid programs. Home health is physician-ordered skilled nursing or therapy, usually short-term, and it's what Medicare covers. Agencies with nearly identical names provide each, so always ask which one you're talking to."}, {"q": "Can in-home care handle dementia?", "a": "Yes, especially in early and middle stages - a consistent, dementia-trained aide in familiar surroundings can work beautifully. The hard limit is usually nighttime: once wandering or overnight needs begin, you need 24-hour shift care, and at that point comparing costs with memory care is worth an honest look."}, {"q": "Does my parent need a doctor's order to get in-home care?", "a": "Only for home health (skilled nursing or therapy billed to Medicare). Companion care and personal care can be arranged directly with an agency or caregiver - no prescription, no diagnosis required."}, {"q": "Can we start small and add hours later?", "a": "Yes, and that's the smartest way to begin. Start with a few visits a week so your parent gets used to a caregiver, then scale up as needs grow. It's far easier to add hours to an established relationship than to introduce a stranger during a crisis."}]
---
...
Agencies sometimes blur these two. Ask exactly which model they're quoting, because the difference can be thousands of dollars a month - see [the real cost of in-home care](/guides/cost-of-in-home-care/).
...
Before you hire, find out what your state requires and whether the agency meets it. Your Area Agency on Aging can tell you who licenses home care where you live. Then read our guide to [hiring in-home care](/guides/hiring-in-home-care/) for how to vet agencies and caregivers yourself - in a lightly regulated industry, your own screening is the real safeguard.
...
Yes, especially in early and middle stages - a consistent, dementia-trained aide in familiar surroundings can work beautifully. The hard limit is usually nighttime: once wandering or overnight needs begin, you need 24-hour shift care, and at that point [comparing costs with memory care](/guides/home-care-or-facility/) is worth an honest look.

**Does my parent need a doctor's order to get in-home care?**
Only for home health (skilled nursing or therapy billed to Medicare). Companion care and personal care can be arranged directly with an agency or caregiver - no prescription, no diagnosis required.

**Can we start small and add hours later?**
Yes, and that's the smartest way to begin. Start with a few visits a week so your parent gets used to a caregiver, then scale up as needs grow. It's far easier to add hours to an established relationship than to introduce a stranger during a crisis.
