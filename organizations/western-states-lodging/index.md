...
org_states: ["UT", "NV", "ID"]
facilities: [{"name": "Legacy House of Centennial Hills", "url": "/directory/nevada/clark-county/las-vegas/legacy-house-of-centennial-hills/", "city_name": "Las Vegas", "state_abbrev": "NV", "care_levels": ["assisted-living", "memory-care"], "facility_size": "large", "description": "Legacy House of Centennial Hills is an assisted living and memory care community in northwest Las Vegas, managed by Western States Lodging & Management. Families consistently highlight the kind, knowledgeable staff and the quality dining program, with staff turnover and cost noted as the main concerns."}]
