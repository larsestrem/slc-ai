...
Do your paper homework first so the tour confirms or contradicts the record, not the other way around. Pull the facility's [inspection reports and ratings](/guides/reading-inspection-reports-and-ratings/), check its complaint history, and skim its pricing so you can ask about [fees that aren't in the base rate](/guides/whats-not-included-hidden-fees/).
...
**Is it really okay to just show up unannounced?**
